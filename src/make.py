...
def main():
    ...
    if file == 'classifier':
        ...
        data_names = [['Blob', 'Iris', 'Diabetes', 'BostonHousing', 'Wine', 'BreastCancer', 'QSAR', 'MIMIC']]
        control_name = [[['None']]]
        ...
        if model in ['linear', 'mlp']:
            local_epoch = ['1', '10']
            data_names = [
                ['Blob', 'Iris', 'Diabetes', 'BostonHousing', 'Wine', 'BreastCancer', 'QSAR', 'MIMIC', 'MNIST',
                 'CIFAR10']]
            ...
            control_2_4 = make_controls(script_name, data_names, model_names, init_seeds, world_size, num_experiments,
                                        resume_mode, control_name)
            data_names = [
                ['Blob', 'Diabetes', 'BostonHousing', 'Wine', 'BreastCancer', 'QSAR', 'MIMIC', 'MNIST', 'CIFAR10']]
