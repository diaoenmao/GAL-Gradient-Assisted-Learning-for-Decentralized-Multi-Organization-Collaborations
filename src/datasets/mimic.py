...
class MIMICL(Dataset):
    ...
    def make_data(self):
        ...
        unique_t = train_df['Glascow coma scale eye opening'].unique()
        print(unique_t)
        unique_t = train_df['Glascow coma scale motor response'].unique()
        print(unique_t)
        unique_t = train_df['Glascow coma scale verbal response'].unique()
        print(unique_t)
        ...
        unique_t = test_df['Glascow coma scale eye opening'].unique()
        print(unique_t)
        unique_t = test_df['Glascow coma scale motor response'].unique()
        print(unique_t)
        unique_t = test_df['Glascow coma scale verbal response'].unique()
        print(unique_t)
        print(test_df)
